...
import { type Formatter, createContext, isNullish, useDateFormatter, useDirection, useKbd, useLocale } from '../utilities'
import {
  type Granularity,
  type HourCycle,
  type SegmentPart,
...
import { createContent, getSegmentElements, initializeSegmentValues, isSegmentNavigationKey, syncSegmentValues } from '../utilities/date'
import type { Direction, FormFieldProps } from '../utilities/types'
...
const editableSegmentContents = computed(() => segmentContents.value.filter(({ part }: any) => part !== 'literal'))
